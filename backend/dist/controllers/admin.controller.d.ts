...
export declare const getPublicFAQs: (_req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const getAllFAQs: (_req: AuthRequest, res: Response) => Promise<Response<any, Record<string, any>>>;
